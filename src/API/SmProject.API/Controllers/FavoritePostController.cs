...
namespace SmProject.API.Controllers
{
    ...
    public class FavoritePostController : ControllerBase
    {
        ...
        /// <summary>
        /// Here you need to fill in the required data in the model in full.
        /// </summary>
        ...
        /// <summary>
        /// With this service, the user can remove the post that he added to his favorites from his favorites.
        /// </summary>
